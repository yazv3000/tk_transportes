...
public class HorarioServicio extends JFrame {
	...
	public HorarioServicio(String orig, String dest, Date fech) {
		this.origen = orig;
		this.destino = dest;
		this.fecha = fech;
	...
	public void initializeFrame() {
		...
		JButton btnSaltar = new JButton("Solo Ida");
		...
		botonBuscar.setIcon(new ImageIcon(HorarioServicio.class.getResource("/imagenes/search.png")));
