...
public class FCiudades extends JFrame {
	...
	public void initializeFrame() {	// método para crear los contenidos del frame
		...
		lblOrigen.setIcon(new ImageIcon(FCiudades.class.getResource("/imagenes/city.png")));
		...
		lblDestino.setIcon(new ImageIcon(FCiudades.class.getResource("/imagenes/city.png")));
		...
		lblFechaDeIda.setIcon(new ImageIcon(FCiudades.class.getResource("/imagenes/calendario.png")));
		...
		lblFechaDeRetorno.setIcon(new ImageIcon(FCiudades.class.getResource("/imagenes/calendario.png")));
		...
		btnBuscar.setIcon(new ImageIcon(FCiudades.class.getResource("/imagenes/buscar_rutas.png")));
		...
		lbIngresoAdmin.setIcon(new ImageIcon(FCiudades.class.getResource("/imagenes/key.png")));
