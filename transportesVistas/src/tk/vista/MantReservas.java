...
public class MantReservas extends JFrame {
	...
	public JTable tablaReservas = new JTable();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MantReservas mc = new MantReservas();
					CtrlReserva c = new CtrlReserva(mc);
					c.listar(mc.tablaReservas);
					mc.setVisible(true);
	...
	public void initializeFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MantReservas.class.getResource("/imagenes/logo.jpg")));
		...
		tablaReservas.setRowHeight(18);
		tablaReservas.getColumnModel().getColumn(0).setPreferredWidth(20);
		tablaReservas.getColumnModel().getColumn(3).setPreferredWidth(40);
		tablaReservas.getColumnModel().getColumn(4).setPreferredWidth(20);
		tablaReservas.getColumnModel().getColumn(5).setPreferredWidth(40);
		tablaReservas.getColumnModel().getColumn(6).setPreferredWidth(100);
		...
		btnBuscar.setIcon(new ImageIcon(MantReservas.class.getResource("/imagenes/search.png")));
