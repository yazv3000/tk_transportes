...
public class FIngresoDatos extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FIngresoDatos ingd = new FIngresoDatos();
	...
	public void initializeFrame() {
		...
		btnCambiarAsIda = new JButton("Cambiar");
