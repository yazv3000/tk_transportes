...
public class MantVendedor extends JFrame {
	...
	public void initializeFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MantClientes.class.getResource("/imagenes/logo.jpg")));
		...
		JLabel lblMantClientes = new JLabel("MANTENIMIENTO DE VENDEDORES");
